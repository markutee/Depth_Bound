...
var upgrades := {
	...
	"oxygen": {"level": 0, "max_level": 3, "costs": [250, 600, 2000]},
...
@onready var oxygen_upgrade: HBoxContainer = $MarginContainer/NinePatchRect/MarginContainer/ShopVbox/OxygenUpgrade
